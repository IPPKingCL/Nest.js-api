...
@Module({
  imports:[
    TypeOrmExModule.forCustomRepository([CocktailRepository,AlchoRecipteRepository,JuiceRecipeRepository,JuiceRepository,alchoRepository,RatingRepository,CocktailCommentRepository]),
